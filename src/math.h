...
struct Vertex
{
    ...
    Vertex(const float x, const float y, const float z, const float w,
           ...
           const Vector4f normal) : position(x, y, z, w), color(color), normal(normal) {}
};
...
struct Cube
{
    ...
    Cube()
    {
        ...
        Vector4f left = {-1, 0, 0, 1};
        Vector4f right = {1, 0, 0, 1};
        Vector4f top = {0, 1, 0, 1};
        Vector4f bottom = {0, -1, 0, 1};
        Vector4f forward = {0, 0, 1, 1};
        Vector4f back = {0, 0, -1, 1};
        vertices = {
            {-0.5, -0.5, 0.5, 1, color0, left},
            {-0.5, 0.5, 0.5, 1, color0, left},
            {-0.5, 0.5, -0.5, 1, color0, left},
            {-0.5, -0.5, -0.5, 1, color0, left},

            {-0.5, -0.5, -0.5, 1, color1, back},
            {-0.5, 0.5, -0.5, 1, color1, back},
            {0.5, 0.5, -0.5, 1, color1, back},
            {0.5, -0.5, -0.5, 1, color1, back},

            {0.5, -0.5, -0.5, 1, color2, right},
            {0.5, 0.5, -0.5, 1, color2, right},
            {0.5, 0.5, 0.5, 1, color2, right},
            {0.5, -0.5, 0.5, 1, color2, right},

            {0.5, -0.5, 0.5, 1, color3, forward},
            {0.5, 0.5, 0.5, 1, color3, forward},
            {-0.5, 0.5, 0.5, 1, color3, forward},
            {-0.5, -0.5, 0.5, 1, color3, forward},

            {-0.5, -0.5, -0.5, 1, color4, bottom},
            {0.5, -0.5, -0.5, 1, color4, bottom},
            {0.5, -0.5, 0.5, 1, color4, bottom},
            {-0.5, -0.5, 0.5, 1, color4, bottom},

            {0.5, 0.5, -0.5, 1, color5, top},
            {-0.5, 0.5, -0.5, 1, color5, top},
            {-0.5, 0.5, 0.5, 1, color5, top},
            {0.5, 0.5, 0.5, 1, color5, top},
        };
